...
var file_chord_proto_rawDesc = string([]byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0xcd, 0x01, 0x0a, 0x05, 0x53, 0x74,
	...
	,
	...
	0x0c, 0x2e, 0x63, 0x68, 0x6f, 0x72, 0x64, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0b, 0x5a,
	0x09, 0x2e, 0x2f, 0x63, 0x68, 0x6f, 0x72, 0x64, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
})
...
var file_chord_proto_depIdxs = []int32{
	...
	7,  // 3: chord.State.data:type_name -> chord.Data
	1,  // 4: chord.State.finger:type_name -> chord.Node
	1,  // 5: chord.State.successors:type_name -> chord.Node
	1,  // 6: chord.State.predecessor:type_name -> chord.Node
	1,  // 7: chord.ChordService.Notify:input_type -> chord.Node
	0,  // 8: chord.ChordService.Health:input_type -> chord.Empty
	2,  // 9: chord.ChordService.FindSuccessor:input_type -> chord.FindSuccessorRequest
	0,  // 10: chord.ChordService.GetPredecessor:input_type -> chord.Empty
	0,  // 11: chord.ChordService.GetSuccessors:input_type -> chord.Empty
	6,  // 12: chord.ChordService.StoreData:input_type -> chord.StoreDataRequest
	8,  // 13: chord.ChordService.DeleteData:input_type -> chord.Id
	0,  // 14: chord.ChordService.PrintState:input_type -> chord.Empty
	6,  // 15: chord.ChordService.Notify:output_type -> chord.StoreDataRequest
	5,  // 16: chord.ChordService.Health:output_type -> chord.HealthResponse
	1,  // 17: chord.ChordService.FindSuccessor:output_type -> chord.Node
	1,  // 18: chord.ChordService.GetPredecessor:output_type -> chord.Node
	3,  // 19: chord.ChordService.GetSuccessors:output_type -> chord.GetSuccessorsResponse
	4,  // 20: chord.ChordService.StoreData:output_type -> chord.Successful
	4,  // 21: chord.ChordService.DeleteData:output_type -> chord.Successful
	9,  // 22: chord.ChordService.PrintState:output_type -> chord.State
