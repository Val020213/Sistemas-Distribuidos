...
type Succesfull struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Succesfull    bool                   `protobuf:"varint,1,opt,name=succesfull,proto3" json:"succesfull,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Succesfull) Reset() {
	*x = Succesfull{}
...
func (x *Succesfull) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Succesfull) ProtoMessage() {}

func (x *Succesfull) ProtoReflect() protoreflect.Message {
	mi := &file_chord_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Succesfull.ProtoReflect.Descriptor instead.
func (*Succesfull) Descriptor() ([]byte, []int) {
	return file_chord_proto_rawDescGZIP(), []int{3}
}

func (x *Succesfull) GetSuccesfull() bool {
	if x != nil {
		return x.Succesfull
	}
	return false
...
var file_chord_proto_rawDesc = string([]byte{
	...
	0x2c, 0x0a, 0x0a, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x66, 0x75, 0x6c, 0x6c, 0x12, 0x1e, 0x0a,
	0x0a, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x66, 0x75, 0x6c, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0a, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x66, 0x75, 0x6c, 0x6c, 0x22, 0x3a, 0x0a,
	...
	0x66, 0x75, 0x6c, 0x6c, 0x12, 0x2d, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x0c,
...
var file_chord_proto_goTypes = []any{
	...
	(*Succesfull)(nil),     // 3: chord.Succesfull
...
var file_chord_proto_depIdxs = []int32{
	...
	3, // 4: chord.ChordService.Notify:output_type -> chord.Succesfull
