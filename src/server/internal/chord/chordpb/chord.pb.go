...
var file_chord_proto_rawDesc = string([]byte{
	...
	0xa1, 0x03, 0x0a, 0x0c, 0x43, 0x68, 0x6f, 0x72, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x61, 0x74, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x63, 0x68, 0x6f, 0x72, 0x64, 0x70, 0x62,
...
var file_chord_proto_depIdxs = []int32{
	...
	6,  // 17: chord.ChordService.Notify:output_type -> chord.StoreDataRequest
	5,  // 18: chord.ChordService.Health:output_type -> chord.HealthResponse
	1,  // 19: chord.ChordService.FindSuccessor:output_type -> chord.Node
	1,  // 20: chord.ChordService.GetPredecessor:output_type -> chord.Node
	3,  // 21: chord.ChordService.GetSuccessors:output_type -> chord.GetSuccessorsResponse
	4,  // 22: chord.ChordService.StoreData:output_type -> chord.Successful
	4,  // 23: chord.ChordService.DeleteData:output_type -> chord.Successful
	9,  // 24: chord.ChordService.PrintState:output_type -> chord.State
