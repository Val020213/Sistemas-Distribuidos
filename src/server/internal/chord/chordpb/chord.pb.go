...
var file_chord_proto_rawDesc = string([]byte{
	...
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32,
	0xc1, 0x04, 0x0a, 0x0c, 0x43, 0x68, 0x6f, 0x72, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x28, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x0b, 0x2e, 0x63, 0x68, 0x6f,
	0x72, 0x64, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x1a, 0x11, 0x2e, 0x63, 0x68, 0x6f, 0x72, 0x64, 0x2e,
	0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x66, 0x75, 0x6c, 0x12, 0x2d, 0x0a, 0x06, 0x48, 0x65,
	...
	,
...
var file_chord_proto_goTypes = []any{
	...
	nil,                           // 12: chord.FindSuccessorRequest.VisitedEntry
	(*timestamppb.Timestamp)(nil), // 13: google.protobuf.Timestamp
}
var file_chord_proto_depIdxs = []int32{
	12, // 0: chord.FindSuccessorRequest.visited:type_name -> chord.FindSuccessorRequest.VisitedEntry
	1,  // 1: chord.GetSuccessorsResponse.successors:type_name -> chord.Node
	7,  // 2: chord.StoreDataRequest.data:type_name -> chord.Data
	13, // 3: chord.Data.created_at:type_name -> google.protobuf.Timestamp
	13, // 4: chord.Data.updated_at:type_name -> google.protobuf.Timestamp
	...
	11, // 20: chord.ChordService.GetNodeData:input_type -> chord.GetNodeDataRequest
	4,  // 21: chord.ChordService.Notify:output_type -> chord.Successful
	5,  // 22: chord.ChordService.Health:output_type -> chord.HealthResponse
	1,  // 23: chord.ChordService.FindSuccessor:output_type -> chord.Node
	1,  // 24: chord.ChordService.GetPredecessor:output_type -> chord.Node
	3,  // 25: chord.ChordService.GetSuccessors:output_type -> chord.GetSuccessorsResponse
	4,  // 26: chord.ChordService.StoreData:output_type -> chord.Successful
	4,  // 27: chord.ChordService.DeleteData:output_type -> chord.Successful
	9,  // 28: chord.ChordService.PrintState:output_type -> chord.State
	7,  // 29: chord.ChordService.RetrieveData:output_type -> chord.Data
	4,  // 30: chord.ChordService.CreateData:output_type -> chord.Successful
	6,  // 31: chord.ChordService.GetNodeData:output_type -> chord.StoreDataRequest
