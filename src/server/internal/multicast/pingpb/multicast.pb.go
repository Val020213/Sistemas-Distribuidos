...
var file_multicast_proto_rawDesc = string([]byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x3c, 0x0a, 0x0b, 0x50, 0x69,
	0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x50, 0x69, 0x6e,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x70, 0x69,
	0x6e, 0x67, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_multicast_proto_rawDescOnce sync.Once
	file_multicast_proto_rawDescData []byte
)

func file_multicast_proto_rawDescGZIP() []byte {
	file_multicast_proto_rawDescOnce.Do(func() {
		file_multicast_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_multicast_proto_rawDesc), len(file_multicast_proto_rawDesc)))
	})
	return file_multicast_proto_rawDescData
}

var file_multicast_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_multicast_proto_goTypes = []any{
...
func file_multicast_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multicast_proto_rawDesc), len(file_multicast_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
